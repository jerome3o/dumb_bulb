...
export const listDevices = async (cloudToken: string): Promise<TapoDevice[]> => {
...
export const listDevicesByType = async (cloudToken: string, deviceType: string): Promise<TapoDevice[]> => {
...
export const setColourTemperature = async (deviceKey: TapoDeviceKey, colourTemperature: number = 2500) => {
  const setBrightnessRequest = {
    "method": "set_device_info",
    "params": {
...
export const setLightParams = async (deviceKey: TapoDeviceKey, { brightness, hue, color_temp, saturation }: LightParams) => {
  const setBrightnessRequest = {
    "method": "set_device_info",
    "params": {
